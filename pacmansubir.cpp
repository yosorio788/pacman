#include <windows.h> // esta libreria sirve para trabajar ls ventanas de windows
#include <conio.h> //esta librería para tener acceso a las siguientes funciones:
#include <stdio.h> //librería estándar de C para funciones de input/output
#define ARRIBA     72    
#define IZQUIERDA  75
#define DERECHA    77
#define ABAJO      80
